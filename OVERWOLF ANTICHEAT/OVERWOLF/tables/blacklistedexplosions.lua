-- Qui configurerai tutte le tue esplosioni nella lista nera, se NON sai cosa stai facendo, lascialo predefinito e segui il tutorial
-- Se sai già di cosa sto parlando, divertiti.

OVERWOLFExplosion = {}

OVERWOLFExplosion.ExplosionsList = {
